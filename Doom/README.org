...
* Doom Main Config:
:PROPERTIES:
:header-args: :tangle ~/.dotfiles/Doom/config.el
...
* packages.el:
:PROPERTIES:
:header-args: :tangle ~/.dotfiles/Doom/packages.el
...
* init.el
:PROPERTIES:
:header-args: :tangle ~/.dotfiles/Doom/init.el
...
* custom.el
:PROPERTIES:
:header-args: :tangle ~/.dotfiles/Doom/custom.el
